...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  if (this.fromfilePrefixChars != null) {
    ...
    console.log('DEBUG: from files', argStrings);
  }
...
ArgumentParser.prototype._readArgsFromFiles = function(argStrings) {
  var arg, arg_line, arg_string, argstrs, content, filename, fs, newArgStrings, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
  // expand arguments referencing files
  fs = require('fs');
  newArgStrings = [];
  for (_i = 0, _len = argStrings.length; _i < _len; _i++) {
    arg_string = argStrings[_i];
    // for regular arguments, just add them back into the list
    if (this.fromfilePrefixChars.indexOf(arg_string[0]) < 0) {
      // if (_ref = arg_string[0], _.indexOf.call(this.fromfilePrefixChars, _ref) < 0) {
      newArgStrings.push(arg_string);
    // replace arguments referencing files with the file content  
      ...
      try {
        ...
        for (_j = 0, _len1 = content.length; _j < _len1; _j++) {
          arg_line = content[_j];
          _ref1 = this.convertArgLineToArgs(arg_line);
...
ArgumentParser.prototype.convertArgLineToArgs = function(arg_line) {
  return [arg_line];
};

...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  var conflicts, groupActions, key;
  this._mutuallyExclusiveGroups.forEach(function (mutexGroup) {
    groupActions = mutexGroup._groupActions;
    groupActions.forEach(function (mutexAction) {
      ...
      groupActions.forEach(function (action) {
        if (actionHash(action) !== key) {conflicts.push(action); }
      });
    });
  });
  
  // alternative, a little closer to the Python
  // using the extra arguments provided by array.forEach
  actionConflicts = {};
  this._mutuallyExclusiveGroups.forEach(function (mutexGroup) {

...
ArgumentParser.prototype._matchArgumentsPartial = function (actions, regexpArgStrings) {
  ...
  for (i = actions.length; i > 0; i -= 1) {
    ...
    for (j in actionSlice) {
      if (actionSlice.hasOwnProperty(j)) {
 ...
 * [1]:http://docs.python.org/dev/library/argparse.html#printing-help
 **/
ArgumentParser.prototype.printUsage = function (stream) {
  this._printMessage(this.formatUsage(), stream);
};
 ...
 * [1]:http://docs.python.org/dev/library/argparse.html#printing-help
 **/
ArgumentParser.prototype.printHelp = function (stream) {
  this._printMessage(this.formatHelp(), stream);
};
